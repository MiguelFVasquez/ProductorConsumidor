...
public class Productor2 extends Thread {
    ...
    public Productor2(Tuberia tuberia, ArrayList<Character> listaEnviados) {
    ...
    public void run() {
        ...
        System.out.println("Letras enviadas con exito desde productor2");
        System.out.println("Letras enviadas por productor2: "+ letrasEnviadas.toString());
    }
    ...
    private synchronized void agregarCaracter(char letra1){
        if (!listaEnviados.contains(letra1)){ //Si la lista no tiene la letra que se va a enviar
            ...
            System.out.println("Enviando la letra: "+ letra1+ " desde productor2");
        }else {
            System.out.println("No se ha enviado la letra: "+ letra1 +" por estar repetida. Desde productor2");
        }
    }
